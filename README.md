# Popularidade ![Badge](https://img.shields.io/badge/Status-Conclu%C3%ADdo-green)

Projeto para apresentar a votação de popularidade entre pessoas desenvolvido no bootcamp fullstack da IGTI
...
1. Clonar via prompt de comando o projeto em uma pasta de sua preferência: `git clone https://github.com/cicerorod/igti-fullstack-mod3-react-votes-frontend.git`
2. Acessar a pasta principal do projeto via prompt de comando. Ex: `cd igti-fullstack-mod3-react-votes-frontend`;
...
1. Faça o _fork_ do projeto (<https://github.com/cicerorod/igti-fullstack-mod3-react-votes-frontend/fork>)
...
Este projeto está sob a licença do MIT. Consulte [LICENSE](https://github.com/cicerorod/igti-fullstack-mod3-react-votes-frontend/blob/master/LICENSE) para obter mais informações.
